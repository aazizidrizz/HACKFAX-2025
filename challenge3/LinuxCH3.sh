...
mkdir -p /home/student/CTF_Challenges/ctf_challenge/level3 || { echo "Failed to create directory"; exit 1; }
cd /home/student/CTF_Challenges/ctf_challenge/level3 || { echo "Failed to access directory"; exit 1; }
