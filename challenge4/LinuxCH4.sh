...
mkdir -p /CTF_Challenges/ctf_challenge/level4 || { echo "Failed to create directory"; exit 1; }
cd /CTF_Challenges/ctf_challenge/level4 || { echo "Failed to access directory"; exit 1; }
